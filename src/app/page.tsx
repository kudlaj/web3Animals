...
export default function Home() {
  return (
      ...
      <Container fluid className="flex-grow-1 d-flex flex-column align-items-center justify-content-center text-center bg-hero-pattern bg-cover bg-center py-5">
        ...
        <h1 className={`display-4 font-bold mb-3 `}>Welcome to the Cute Animals <br/>DEATHLY Fight Club!</h1>
        ...
        <Row className="justify-content-center py-5">
            ...
            <Col  xs="auto" className="m-2">
              <div className={`${styles.animalCircle} ${styles.pos1}`} >
                  <img src="/animals/small/dirty_lemur.png" width={184} height={184} className="img-fluid rounded-circle" />
                </div>
            </Col>
            <Col  xs="auto" className="m-2">
              <div className={`${styles.animalCircle} ${styles.pos2}`} >
                  <img src="/animals/small/dirty_panda.png" width={184} height={184} className="img-fluid rounded-circle" />
                </div>
            </Col>
            <Col  xs="auto" className="m-2">
              <div className={`${styles.animalCircle} ${styles.pos2}`} >
                  <img src="/animals/small/dirty_red-shanked-douc.png" width={184} height={184} className="img-fluid rounded-circle" />
                </div>
            </Col>
            <Col  xs="auto" className="m-2">
                <div className={`${styles.animalCircle} ${styles.pos2}`} >
                  <img src="/animals/small/dirty_slow_loris.png" width={184} height={184} className="img-fluid rounded-circle" />
                </div>
            </Col>
            <Col  xs="auto" className="m-2">
              <div className={`${styles.animalCircle} ${styles.pos1}`} >
                  <img src="/animals/small/crazy_panda.png" width={184} height={184} className="img-fluid rounded-circle" />
                </div>
            </Col>
        </Row>
      </Container>
